...
%\VignetteIndexEntry{BiostringsTools: Tools based on Biostrings (alignment, classification, database)}
...
blast <- BLAST(db="~/BiostringsTools/16SMicrobialDB/16SMicrobial")
blast
@
