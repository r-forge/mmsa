...
The command \func{addSequences} will automatically read and parse Greengenes fasta files and
...
processSequences(system.file("examples/phylums",package="MMSA"),db1)
@
